...
class Goods(models.Model):
    ...
    goods_under = models.IntegerField(verbose_name='商品状态',default=1) #0下架  1 上架

    goods_type = models.ForeignKey(to=GoodType,on_delete=models.CASCADE,verbose_name='商品类型')
